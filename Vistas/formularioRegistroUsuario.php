<?php 
	...
	if ($_FILES['FotoPerfil']['error']){
		...
		if((isset($_FILES['FotoPerfil']['name']) && ($_FILES['FotoPerfil']['error']==UPLOAD_ERR_OK))){
			...
			$ruta_imagen = "../imagenes/" .$_POST['Usuario'].".jpg";
			$creado = ControladorUsuario::AltaUsuario($_POST['NombreUsuario'],$_POST['ApellidoUsuario'],$_POST['CorreoUsuario'],$_POST['ContrasenaUsuario'], $_POST['Usuario'], $_POST['Usuario'].".jpg");
			if ($creado){
